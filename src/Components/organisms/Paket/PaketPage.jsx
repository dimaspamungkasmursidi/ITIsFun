...
const PaketPage = () => {
    ...
    return (
      <>
        ...
        <div className="flex items-center sm:justify-center gap-4 py-4 overflow-x-scroll overflow-y-hidden categories-filter">
          {[
            "Semua Kategori",
            "Landing Page",
            "Profile Company",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredItems.map((item, index) => {
              return (
                <Card item={item} index={index} key={index} openModal={openModal} />
              );
            })}
          </div>
        </section>
